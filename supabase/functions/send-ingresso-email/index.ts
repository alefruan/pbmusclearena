...
function createIngressoEmailTemplate(data: IngressoData): string {
  ...
  return `
    ...
    <head>
        ...
        <title>Ingresso Confirmado - PB MUSCLE ARENA</title>
    </head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#1a1a1a;border-radius:12px;overflow:hidden;border:1px solid #2a2a2a;">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#dc5e28 0%,#b84a1e 100%);padding:36px 32px;text-align:center;">
                            ...
                            <div style="font-size:14px;font-weight:600;color:rgba(255,255,255,0.85);letter-spacing:1px;text-transform:uppercase;">Ingresso Confirmado!</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#aaaaaa;line-height:1.7;">
                                Seu ingresso para o <strong style="color:#dc5e28;">PB MUSCLE ARENA 2026</strong> foi registrado com sucesso. Guarde o número abaixo — ele será solicitado na entrada do evento.
                            </p>

                            <!-- Número do ingresso em destaque -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#dc5e28,#b84a1e);border-radius:10px;margin-bottom:28px;">
                                <tr><td style="padding:24px;text-align:center;">
                                    <div style="font-size:12px;font-weight:700;letter-spacing:3px;color:rgba(255,255,255,0.7);text-transform:uppercase;margin-bottom:8px;">Número do Ingresso</div>
                                    <div style="font-size:32px;font-weight:900;color:#ffffff;letter-spacing:4px;">#${ingressoNumero}</div>
                                </td></tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#242424;border-radius:10px;border:1px solid #333;margin-bottom:24px;">
                                <tr><td style="padding:18px 20px 10px;border-bottom:1px solid #333;">
                                    <span style="font-size:11px;font-weight:800;letter-spacing:2px;color:#dc5e28;text-transform:uppercase;">Dados do Comprador</span>
                                </td></tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#242424;border-radius:10px;border:1px solid #333;margin-bottom:28px;">
                                ...
                                <tr><td style="padding:16px 20px;">
                                    <p style="margin:0 0 8px;font-size:14px;color:#cccccc;">&#8250;&nbsp; Apresente um documento com foto na entrada</p>
                                    <p style="margin:0 0 8px;font-size:14px;color:#cccccc;">&#8250;&nbsp; Chegue com antecedência para evitar filas</p>
                                    <p style="margin:0;font-size:14px;color:#cccccc;">&#8250;&nbsp; O evento começará pontualmente no horário programado</p>
                                </td></tr>
                            </table>

                            <p style="margin:0 0 4px;font-size:14px;color:#888;text-align:center;">Dúvidas? Fale conosco:</p>
                            <p style="margin:0;font-size:14px;color:#dc5e28;text-align:center;font-weight:600;">ingresso@pbmusclearena.com</p>
